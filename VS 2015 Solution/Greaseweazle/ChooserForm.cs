...
namespace Greaseweazle
{
    public partial class ChooserForm : Form
    {
        ...
        public static string m_sExtFilter = "Images|*.a2r;*.adf;*.ads;*.adm;*.adl;*.ctr;*.dim;*.dsd;*.dsk;*.d64;*.d71;*.d81;*.d88;*.edsk;*.fdi;*.hdm;*.hfe;*.img;*.ima;*.imd;*.ipf;*.mgt;*.sf7;*.st;*.scp;*.td0|All files (*.*)|*.*";
        ...
        public static string[] m_sarrExtensions = new string[35] {".a2r", ".adf",".ads",".adm",".adl",".ctr",".d64",".d71",".d81",".d88",".dim",".dsd",".dsk",".edsk",".fdi",".hdm", ".hfe::version=3", ".hfe",".img",".ima",".imd",".ipf",".mgt",".0.raw",".ctr::revs=3",".scp",".scp::disktype=amiga", ".scp::disktype=c64",".scp::revs=3",".sf7",".ssd",".st",".st",".td0",".xdf"};
