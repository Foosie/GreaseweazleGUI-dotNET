...
namespace Greaseweazle
{
    public partial class ChooserForm : Form
    {
        ...
        public static string m_sExtFilter = "Images|*.a2r;*.adf;*.ads;*.adm;*.adl;*.ctr;*.dim;*.dsd;*.dsk;*.d64;*.d71;*.d81;*.d88;*.edsk;*.fdi;*.gcr;*.hdm;*.hfe;*.img;*.ima;*.imd;*.ipf;*.mgt;*.sf7;*.st;*.scp;*.td0|All files (*.*)|*.*";
        public static string[] m_sarrDefaultFormats = new string[64] {"acorn.adfs.160","acorn.adfs.320","acorn.adfs.640","acorn.adfs.800","acorn.adfs.1600","acorn.dfs.ss","acorn.dfs.ds","akai.800","akai.1600","amiga.amigados","amiga.amigados_hd","apple2.appledos.140","apple2.prodos.140","atari.90","atarist.360","atarist.400","atarist.440","atarist.720","atarist.800","atarist.880","commodore.1541","commodore.1571","commodore.1581","dec.rx01","dec.rx02","ensoniq.800", "ensoniq.1600", "ensoniq.mirage","gem.1600","hp.mmfm.9885","hp.mmfm.9895","ibm.160","ibm.180","ibm.320","ibm.360","ibm.720", "ibm.800", "ibm.1200", "ibm.1440", "ibm.1680","ibm.2880", "ibm.dmf","ibm.scan", "mac.400","mac.800","msx.1d","msx.1dd","msx.2d","msx.2dd","northstar.fm.ss","northstar.fm.ds","northstar.mfm.ss","northstar.mfm.ds","occ1.sd","occ1.dd","pc98.2d","pc98.2dd","pc98.2hd","pc98.2hs","pc98.n88basic.hd","sci.prophet","sega.sf7000","zx.trdos.640","zx.quorum.800"};
        public static string[] m_sarrExtensions = new string[36] {".a2r", ".adf",".ads",".adm",".adl",".ctr",".d64",".d71",".d81",".d88",".dim",".dsd",".dsk",".edsk",".fdi",".gcr", ".hdm", ".hfe::version=3", ".hfe",".img",".ima",".imd",".ipf",".mgt",".0.raw",".ctr::revs=3",".scp",".scp::disktype=amiga", ".scp::disktype=c64",".scp::revs=3",".sf7",".ssd",".st",".st",".td0",".xdf"};
        ...
        public static string m_sStatusLine = "for Host Tools 1.18";
        #endregion
        ...
        private void InitializeMyStuff()
        {
            ...
            this.mnuDefaults.ForeColor = Color.White;
        ...
        #region mnuDefaults_Click
        private void mnuDefaults_Click(object sender, EventArgs e)
        {
            DialogResult drRet = MessageBox.Show("This will reset all changes back to defaults!\nAre you sure?", "Selected Profile = " + Path.GetFileNameWithoutExtension(m_sIniFile), MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
            if (drRet != DialogResult.OK)
                return;

            m_Ini.IniWriteValue("gbAction", null, null);
            m_Ini.IniWriteValue("gbUSBPorts", null, null);
            m_Ini.IniWriteValue("gbGlobals", null, null);
            m_Ini.IniWriteValue("gbReadFromDisk", null, null);
            m_Ini.IniWriteValue("gbWriteToDisk", null, null);
            m_Ini.IniWriteValue("gbClean", null, null);
            m_Ini.IniWriteValue("gbEraseDisk", null, null);
            m_Ini.IniWriteValue("gbConvert", null, null);
            m_Ini.IniWriteValue("gbInfo", null, null);
            m_Ini.IniWriteValue("gbReset", null, null);
            m_Ini.IniWriteValue("gbPinLevel", null, null);
            m_Ini.IniWriteValue("gbRPM", null, null);
            m_Ini.IniWriteValue("gbSeekCyl", null, null);
            m_Ini.IniWriteValue("gbSetDelays", null, null);
            m_Ini.IniWriteValue("gbUpdateFirmware", null, null);
