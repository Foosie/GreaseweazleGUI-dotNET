...
namespace Greaseweazle
{
    public partial class ChooserForm : Form
    {
        ...
        public static string[] m_sarrExtensions = new string[26] {".adf",".ads",".adm",".adl",".d81",".d88",".dim",".dsd",".dsk",".fdi",".hdm", ".hfe::version=3", ".hfe",".img",".ima",".imd",".ipf",".mgt",".raw",".scp",".scp::disktype=amiga",".scp::disktype=c64",".sf7",".ssd",".st",".xdf"};
